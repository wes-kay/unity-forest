...
for uid, name in skills:
    lines.append(f"  - uid: {uid}")
    lines.append(f"    name: {name}")
    lines.append(f"    stringValue: 0")
    lines.append(f"    upgradeIncrement: 0")
    lines.append(f"    coreStats: 1")
    lines.append(f"    visible: 1")
    lines.append(f"    visibleInStatsPanel: 1")
    lines.append(f"    displayFormat: 1")
    lines.append(f"    suffixes: {uid}")
    lines.append(f"    compareInfo: 1")
    lines.append(f"    defaultValue: 0")
